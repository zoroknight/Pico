...
void PPlayerState::SetPlayerId(int32 InPlayerId) { PlayerId = InPlayerId; }
float PPlayerState::GetScore() const { return Score; }
void PPlayerState::SetScore(float InScore) { Score = InScore; }
bool PPlayerState::IsSpectator() const { return bIsSpectator; }
void PPlayerState::SetIsSpectator(bool bValue) { bIsSpectator = bValue; }
}
